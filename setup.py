...
setup(
    name="anatomically-constrained-ssl",
    version="0.0.1",
    description="Anatomically Constrained Semi-supervised Learning",
    author="Thierry Judge",
    author_email="thierry.judge@usherbrooke.ca",
    url="https://github.com/ThierryJudge/echo-segmentation-uncertainty",
    license="Apache-2.0",
